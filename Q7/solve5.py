...
results = [d["url"] for d in index if eval_query(d, possible_tokens)]
if set(results) == set(targets):
    print("PERFECT MATCH with 6 exact tokens:", possible_tokens)
else:
    print("False pos:", set(results) - set(targets))
    print("False neg:", set(targets) - set(results))
